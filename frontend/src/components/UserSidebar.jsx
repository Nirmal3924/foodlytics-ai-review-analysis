import { FiHome, FiAward, FiGrid, FiBookmark, FiClock, FiMenu, FiSun, FiMoon, FiX } from 'react-icons/fi'
...
export default function UserSidebar({ hasFilter, viewAllRestaurants, onClearFilters, isCollapsed, onToggleCollapse, isMobileOpen, onMobileClose }) {
  ...
  const sidebarItems = [
    ...
    { id: 'hiddenGems', label: 'Hidden Gems', icon: FaGem, path: '/dashboard/hidden-gems' },
