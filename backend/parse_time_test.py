...
test_cases = ['12 Noon to 12 Midnight', '11:30 AM to 1 AM', '11 AM to 11 PM', '12 Noon to 11 PM', '11 AM to 12 Midnight', '11am to 11pm (Mon-Sun)', '6 AM to 11:30 PM', '12:30 PM to 3:30 PM, 7 PM to 11 PM']

for t in test_cases:
    # Test with a specific time: 2:00 PM (14:00)
    dt = datetime(2023, 1, 1, 14, 0)
    print(f"{t}: {is_open_now(t, dt)}")
    # Test with 8:00 PM (20:00)
    dt2 = datetime(2023, 1, 1, 20, 0)
    print(f"  at 8PM: {is_open_now(t, dt2)}")
